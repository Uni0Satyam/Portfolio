...
function Hero() {
    ...
    useGSAP(
        () => {
            ...
            tl.from(header2.current, {
                y: -100,
                duration: 0.6,
                opacity: 0,
                ease: "bounce.inOut",
            });
            tl.from(para4.current, {
                y: 100,
                opacity: 0,
                stagger:0.2,
            });
            tl.from(header3.current, {
                y: -100,
                duration: 0.6,
                opacity: 0,
                ease: "bounce.inOut",
            });
            tl.from(skillParent.current, {
                y: 100,
                opacity: 0,
            });
        },
        ...
        <section className="bg-[#202123] px-12 md:px-12 lg:px-24 xl:px-32 py-30" ref={aboutContainer}>
            <div className="text-[#999]">
                <div className="grid grid-cols-1">
                    ...
                    <h6 className='mt-3' ref={para1}>Hey, I'm Satyam Kushwaha — a full stack web developer from Prayagraj, Uttar Pradesh. I love building clean, responsive, and scalable web applications using tools like HTML, CSS, JavaScript, TypeScript, React, Tailwind CSS and Bootstrap. Along the way, I've also worked with things like Framer Motion, API integration, Context API, Git, and GitHub. After completing my 12th in 2024 with 71%, Then from 2024, I am pursuing my B.C.A. from K.P. Higher Education Institute (KPHEI). I've been focused on sharpening my frontend, backend, and along with that learning about Gen AI.</h6>
                    <h6 className='mt-3' ref={para2}>Some of my key projects include BotForge AI (a multi-model AI chatbot platform), Fashion Market (an e-commerce frontend), Pixisphere (a photographer discovery platform), and more. I also enjoy participating in Hackathons. Right now, I’m actively looking for job, internship opportunities and building full-stack capabilities alongside AI-based tools. You can reach out to me at <a href="https://mail.google.com/mail/u/0/?fs=1&href=satyamkushwaha10c@gmail.com&su=Hiring!&tf=cm" target="_blank" className="border-b-2 border-[var(--primary)]">satyamkushwaha10c@gmail.com</a>, or check out my work on <a href="https://github.com/Uni0Satyam" target="_blank" className="border-b-2 border-[var(--primary)]">GitHub</a> and <a href="https://www.linkedin.com/in/satyam-kushwaha011/" target="_blank" className="border-b-2 border-[var(--primary)]">LinkedIn.</a></h6>
                    <div className="border-l-2 border-white/10 pl-4 mt-8 space-y-2" style={{ opacity: "1", transform: 'none' }} ref={para3}>
                        ...
                        <p className="text-neutral-300">• Built real apps: news UI, portfolios, e-commerce, and multi-model chatbots.</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-3 flex-wrap" ref={skillParent}>
                            ...
                            <SmallBadge title="JavaScript"></SmallBadge>
                            <SmallBadge title="See More" icon={<ArrowRightAltIcon />} link="/#skill"></SmallBadge>
                        </div>
                    </div>
                </div>
            </div>
